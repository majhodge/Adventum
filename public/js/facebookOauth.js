...
//     FB.api(
//         '/me',
//         'GET', { "fields": "id,name,posts.limit(5){message,place,picture,created_time}" },
//         function(response) {
//             console.log(response);
//             //filterNewJson(response)
//         }
//     );
// }
...
// function filterNewJson(result) {
//     var places = [];
//     var username = result.name;
//     var message, name, picUrl = '';
//     var lat, lng = 0;

//     for (var i = 0; i < result.posts.data.length; i++) {
//         // check for facebook message
//         if (result.posts.data[i].message != null) {
//             //console.log(result.posts.data[i].message);
//             message = result.posts.data[i].message;
//         }

//         //check for place name
//         if (result.posts.data[i].place != null) {
//             //console.log(result.posts.data[i].place.name);
//             name = result.posts.data[i].place.name;
//             lat = result.posts.data[i].place.location.latitude;
//             lng = result.posts.data[i].place.location.longitude;
//         }

//         // if (result.posts.data[i].picture != null) {
//         //     picUrl = result.posts.data[i].picture;
//         // }
//         // console.log("-----------------");
//         // console.log(message);
//         // console.log(name);
...
//     var packed = jsonpack.pack(object)
//     $.post("/fbData?object=" + packed, function(response) {
